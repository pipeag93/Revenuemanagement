...
class PropertyPerformance(db.Model):
    ...
    total_monthly_revenue   = db.Column(db.Float, nullable=True)
    total_nights_available  = db.Column(db.Float, nullable=True)
    nights_sold             = db.Column(db.Float, nullable=True)
